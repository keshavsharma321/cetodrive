...
<div className="container mx-auto p-4 sm:p-6 mt-16 max-w-8xl">
      <div className="mb-8">
        <h1 className="text-xl sm:text-4xl font-bold text-black mb-4 sm:mb-6 text-center">Select a vehicle group</h1>
        ...
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {filteredVehicles.map((vehicle, index) => (
            ...
            >
              ...
              <button onClick={() => handleImageClick()}  className="w-full bg-[#3563e9] text-white py-2 rounded-md text-sm">
                View Details
              </button>
            </div>
          ))}
