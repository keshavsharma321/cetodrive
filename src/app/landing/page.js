      ...
      <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-20 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center mt-8 md:mt-10">
            <button className="flex items-center gap-2 px-6 py-3 bg-white text-[#ea580c] font-semibold rounded-full shadow-md hover:shadow-lg transition-shadow">
              See All
      ...
      <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-20 bg-gray-50">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-10 items-center">
          ...
          <div className="space-y-6 order-1 md:order-2">
            ...
            <button className="bg-[#ea580c] text-white px-6 py-3 rounded-md font-medium flex items-center gap-2 mx-auto md:mx-0">
              Start Your Journey
