              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <select className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-500">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm sticky top-4">
              ...
              <div className="flex items-center mb-6">
                <div className="w-24 h-16  rounded-lg mr-4 flex items-center justify-center">
                  <Image
      src={Profile}// or a remote image: "https://example.com/image.jpg"
      alt="Description"
      width={88} // same as w-20 (20 * 4 = 80px)
      height={48} // same as h-12 (12 * 4 = 48px)
      className="rounded"
    />
                </div>
                <div>
