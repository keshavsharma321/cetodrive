...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://143.110.242.217:8031/api/customer/login", {
        method: "POST",
        headers: {
 ...
 <button className="border-2 border-amber-600 p-2 text-orange-600 rounded-xl" onClick={rentcar}>
                         Rent Your Car
                        </button>
             {/* Mobile menu button */}
